...
import { InternalEnforcer } from "./internal_enforcer.ts";
...
export class ManagementEnforcer extends InternalEnforcer {
   ...
   * @return succeeds or not.
   */
  public async removeNamedPolicies(
    ptype: string,
    rules: string[][],
  ): Promise<boolean> {
  ...
  public async removeFilteredNamedPolicy(
    ...
    return this.removeFilteredPolicyInternal(
      "p",
      ptype,
      fieldIndex,
      fieldValues,
   ...
   * @return succeeds or not.
   */
  public async addNamedGroupingPolicies(
    ptype: string,
    rules: string[][],
  ): Promise<boolean> {
   ...
   * @return succeeds or not.
   */
  public async removeNamedGroupingPolicies(
    ptype: string,
    rules: string[][],
  ): Promise<boolean> {
