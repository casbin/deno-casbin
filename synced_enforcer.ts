...
import { AwaitLock } from "./deps.ts";
import { Enforcer, newEnforcerWithClass } from "./enforcer.ts";
import { Watcher } from "./persist/mod.ts";
...
export class SyncedEnforcer extends Enforcer {
   ...
   */
  public async getFilteredNamedPolicy(
    ptype: string,
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<string[][]> {
   ...
   */
  public async getFilteredGroupingPolicy(
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<string[][]> {
   ...
   */
  public async getFilteredNamedGroupingPolicy(
    ptype: string,
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<string[][]> {
   ...
   * @return succeeds or not.
   */
  public async removeNamedPolicy(
    ptype: string,
    ...params: string[]
  ): Promise<boolean> {
    await this.lock.acquireAsync();
    return this.removePolicyInternal("p", ptype, params).finally(() =>
      this.lock.release()
    );
  }
   ...
   * @return succeeds or not.
   */
  public async removeFilteredNamedPolicy(
    ptype: string,
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<boolean> {
   ...
   * @return whether the rule exists.
   */
  public async hasNamedGroupingPolicy(
    ptype: string,
    ...params: string[]
  ): Promise<boolean> {
    await this.lock.acquireAsync();
   ...
   * @return succeeds or not.
   */
  public async addNamedGroupingPolicy(
    ptype: string,
    ...params: string[]
  ): Promise<boolean> {
    await this.lock.acquireAsync();
   ...
   * @return succeeds or not.
   */
  public async removeFilteredGroupingPolicy(
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<boolean> {
    return this.removeFilteredNamedGroupingPolicy(
      "g",
      fieldIndex,
      ...fieldValues,
    );
   ...
   * @return succeeds or not.
   */
  public async removeNamedGroupingPolicy(
    ptype: string,
    ...params: string[]
  ): Promise<boolean> {
    await this.lock.acquireAsync();
   ...
   * @return succeeds or not.
   */
  public async removeFilteredNamedGroupingPolicy(
    ptype: string,
    fieldIndex: number,
    ...fieldValues: string[]
  ): Promise<boolean> {
...
export async function newSyncedEnforcer(
  ...params: any[]
): Promise<SyncedEnforcer> {
